...
class DClabShell(Cmd):
    ...
    def do_run(self, inp):
        ...
        os.system("~/onos/bin/onos-app 127.0.0.1 uninstall org.onosproject.dclab")
        time.sleep(1)
        os.system("~/onos/bin/onos-app 127.0.0.1 reinstall! ~/dclab-source/dclab/target/onos-app-dclab-2.1.0.oar ")
